var countPart1 = 0;
var countPart2 = 0;
var field = File.ReadLines("../../../../Day04/Day04.txt").ToArray();
for (var y = 0; y < field.Length; y++)
{
    for (var x = 0; x < field[y].Length; x++)
    {
        ...
        {
            case 'X':
                countPart1 += CheckX(y, x);
                break;
            case 'A':
                countPart2 += CheckA(y, x);
                break;
        }
    }
}
